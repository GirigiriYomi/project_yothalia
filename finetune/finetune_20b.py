...
model = AutoModelForCausalLM.from_pretrained("../yothalia/server/model_weights/internlm/internlm-chat-20b-finetune", 
                                                load_in_4bit = True,
                                                #peft_config=config,
                                                #device_map="auto",
...
tokenizer = AutoTokenizer.from_pretrained("../yothalia/server/model_weights/internlm/internlm-chat-20b-finetune",
                                            trust_remote_code=True)


peft_model_id = "../yothalia/server/model_weights/internlm/internlm-chat-20b-int4-finetune-lora"
